...
<style>
  .sm-root {
    ...
    border: 1px solid var(--color-accent-subtle, var(--color-accent-muted));
  ...
  .sm-header {
    ...
    border-bottom: 1px solid var(--color-border-subtle, var(--color-accent-subtle));
  }
  ...
  .sm-swatch--kos { background: var(--color-accent, var(--color-accent)); }
