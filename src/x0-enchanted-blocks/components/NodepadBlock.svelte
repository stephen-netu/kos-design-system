...
<style>
  .nodepad-block {
    ...
    border-left: 3px solid var(--type-color, var(--color-accent));
  ...
  .nodepad-block:focus-within {
    ...
    outline: 2px solid color-mix(in srgb, var(--type-color, var(--color-accent)) 50%, transparent);
    outline-offset: 2px;
  }
  ...
  .type-chip {
    ...
    background: color-mix(in srgb, var(--type-color, var(--color-accent)) 15%, transparent);
    border: 1px solid color-mix(in srgb, var(--type-color, var(--color-accent)) 25%, transparent);
    border-radius: 4px;
    font-size: 11px;
    font-weight: 500;
  ...
  .type-chip:hover {
    background: color-mix(in srgb, var(--type-color, var(--color-accent)) 25%, transparent);
    border-color: color-mix(in srgb, var(--type-color, var(--color-accent)) 50%, transparent);
  }
  ...
  .block-content {
    ...
    min-height: 1.6em;
    outline: none;
    caret-color: var(--type-color, var(--color-accent));
  }
  ...
  .save-indicator {
    ...
    height: 6px;
    border-radius: 50%;
    background: var(--type-color, var(--color-accent));
