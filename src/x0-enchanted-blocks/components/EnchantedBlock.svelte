...
<style>
  ...
  .enchanted-block.editing {
    border-left-width: 4px;
    box-shadow: 0 0 0 2px var(--type-color, var(--color-accent));
  }
  ...
  .type-badge {
    ...
    background: color-mix(in hsl, var(--type-color, var(--color-accent)) 15%, transparent);
    border: 1px solid color-mix(in hsl, var(--type-color, var(--color-accent)) 30%, transparent);
  ...
  .type-badge:hover {
    background: color-mix(in hsl, var(--type-color, var(--color-accent)) 25%, transparent);
    border-color: color-mix(in hsl, var(--type-color, var(--color-accent)) 50%, transparent);
  }
