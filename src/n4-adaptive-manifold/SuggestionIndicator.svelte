...
<style>
  .n4-suggestion {
    ...
    background: var(--n4-suggestion-bg, color-mix(in srgb, var(--color-accent, var(--color-accent)) 8%, var(--color-bg-panel, #222)));
    border: 1px solid var(--n4-suggestion-border, var(--color-accent-muted));
  ...
  .n4-suggestion__icon {
    color: var(--n4-suggestion-accent, var(--color-accent));
    font-size: 13px;
    line-height: 1;
  }
  ...
  .n4-suggestion__action:hover {
    color: var(--n4-suggestion-accent, var(--color-accent));
    border-color: var(--n4-suggestion-border, var(--color-accent-muted));
  }
