<script lang="ts">
  ...
  let { groups, isOpen, onClose, onShortcutClick, searchable, title }: Props = $props();
...
{#if isOpen}
  <div class="shortcuts-overlay" role="dialog" aria-modal="true" aria-label={title || 'Keyboard shortcuts'}>
    <div class="shortcuts-panel">
      <header class="panel-header">
        <h2 class="panel-title">{title || 'Keyboard shortcuts'}</h2>
