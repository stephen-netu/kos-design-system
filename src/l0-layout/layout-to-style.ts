...
export function layoutToStyle(layout: Layout): string {
  ...
  const vars: string[] = [
    ...
    `--layout-padding-top: ${layout.padding[0]}px`,
    `--layout-padding-right: ${layout.padding[1]}px`,
    `--layout-padding-bottom: ${layout.padding[2]}px`,
    `--layout-padding-left: ${layout.padding[3]}px`,
