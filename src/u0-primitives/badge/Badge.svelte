...
<style>
  ...
  .variant-count.color-success { background: var(--color-success); color: var(--color-text-inverse); }
  .variant-count.color-warning { background: var(--color-warning); color: var(--color-text-inverse); }
  .variant-count.color-error { background: var(--color-error); color: var(--color-text-inverse); }
  .variant-count.color-info { background: var(--color-info); color: var(--color-text-inverse); }
  .variant-count.color-neutral { background: var(--color-text-tertiary); color: var(--color-text-inverse); }
