      ...
      <div class="overview">
        ...
        <div class="field-row">
          ...
          {#if detail.expert && typeof detail.expert === 'object'}
            <span class="placeholder-badge">{detail.expert.name}</span>
          {:else}
        ...
        <div class="field-row">
          ...
          <span class="placeholder-gauge">Stage {detail.allay.stage}</span>
        </div>
        <div class="field-row">
          <span class="field-label">ASSAY</span>
          {#if detail.assay}<span class="placeholder-badge">{detail.assay.gate}</span>{/if}
        </div>
      </div>
